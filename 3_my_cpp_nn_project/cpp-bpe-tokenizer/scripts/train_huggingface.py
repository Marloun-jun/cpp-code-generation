...
# @brief Обучение HuggingFace BPE токенизатора на корпусе C++ кода
#
# @author Евгений П.
# @date 2026
# @version 3.2.0
...
#          на корпусе C++ кода для последующего сравнения с собственной
#          реализацией.
#
...
def main() -> int:
    ...
    """
    parser = argparse.ArgumentParser(description='Обучение HuggingFace BPE токенизатора')
    ...
    for text in test_texts:
        ...
        print(f"   Совпадает: {'✓' if text == decoded else '✗'}")
